...
using FairShare.AppBackend.Services;
using FairShare.AppBackend.Options;
using FairShare.AppBackend.Middleware;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(FairShare.AppFrontend._Imports).Assembly);
