...
using AppFrontend.Pages;
using AppBackend.Components;
using AppBackend.Components.Account;
using AppBackend.Data;
using AppShared.Models;
using AppShared.Interfaces;
using AppShared.Calculators;
using AppShared.Services;
using AppBackend.Services;
using AppBackend.Options;
using AppBackend.Middleware;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(AppFrontend._Imports).Assembly);
