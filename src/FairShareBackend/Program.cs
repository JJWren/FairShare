...
using FairShareBackend.Components;
using FairShareBackend.Components.Account;
...
using FairShareBackend.Services;
using FairShareBackend.Options;
using FairShareBackend.Middleware;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(FairShareFrontend._Imports).Assembly);
