...
using global::FairShare.Frontend.Pages;
using FairShare.Backend.Components;
using FairShare.Backend.Components.Account;
using FairShare.Backend.Data;
using global::FairShare.Shared.Models;
using global::FairShare.Shared.Interfaces;
using global::FairShare.Shared.Calculators;
using global::FairShare.Shared.Services;
using FairShare.Backend.Services;
using FairShare.Backend.Options;
using FairShare.Backend.Middleware;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(FairShare.Frontend._Imports).Assembly);
